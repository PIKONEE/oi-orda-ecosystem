...
class MainActivity : AppCompatActivity() {
    ...
    // LEGACY-20: сканера нет — ключ из 20 символов вводится с клавиатуры
    // на экране активации и приходит сюда через Android.activateKey().
    ...
    inner class JsBridge {
        ...
        // scanQr() намеренно отсутствует: в LEGACY-20 сканера нет. Экран
        // активации на это рассчитан — кнопки QR там тоже нет.
